...
namespace DataAccessLayer
{
    public class DAL
    {
        ...
        string strConnect = @"Data Source=KANEPHAN\KANEPHANSQL;Initial Catalog=QUANLYSV;User ID=sa;Encrypt=False";

        public void changeStrConnectToSinhVien()
        {
            strConnect = @"Data Source = KANEPHAN\KANEPHANSQL; Initial Catalog = QUANLYSV; Persist Security Info = True; User ID = sinhvien; Password = sinhvien";
        ...
        {
            strConnect = @"Data Source = KANEPHAN\KANEPHANSQL; Initial Catalog = QUANLYSV; Persist Security Info = True; User ID = giangvien; Password = giangvien";
            cnn = new SqlConnection(strConnect);
            cmd = cnn.CreateCommand();
        }
